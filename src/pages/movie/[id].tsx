...
export async function getServerSideProps(ctx: NextPageContext) {
  const URL = process.env.NODE_ENV === 'development' ? 'http://localhost:3000' : 'https://' + process.env.NEXT_PUBLIC_VERCEL_URL ? process.env.NEXT_PUBLIC_VERCEL_URL : process.env.RAILWAY_STATIC_URL;
