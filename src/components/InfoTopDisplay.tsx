    ...
    <div className={styles.topSection}>
      <div className={styles.poster}>
        <Image
          ...
          height={900}
          sizes="20vw"
          alt={'Film poster of ' + filmInfo.title}
      ...
      <div className={styles.mainInfo}>
        ...
        <div className={styles.links}>
          {filmInfo.imdb_id && (
            <a href={'https://www.imdb.com/title/' + filmInfo.imdb_id}>
              <SiImdb className={styles.link} />
            </a>
          )}
          {filmInfo.homepage && (
            <a href={filmInfo.homepage}>
              <BsCursor className={styles.link} />
            </a>
          )}
        </div>
        {director.length > 0 && (
